...
Although the first function will be called to generate the menu, the file
...
Custom server actions can be added to the quick action menu on host and service detail pages.
There is a detailed example in the link:custom-quick-actions.html[quick actions] documentation.
