...
NOTE: Disabling escaping renders plugin output without sanitizing it and
inserts it directly into the page. Only use this for plugins you trust. It can
influence or restyle the rest of the interface.
