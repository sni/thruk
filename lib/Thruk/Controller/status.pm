...
sub _process_combined_page {
    ...
    push @{$extra_svc_columns}, 'contacts' if (ref $selected_svc_columns eq 'ARRAY' && grep { /^contacts$/ixm } @{$selected_svc_columns});
    ...
    push @{$extra_hst_columns}, 'contacts' if (ref $selected_hst_columns eq 'ARRAY' && grep { /^contacts$/ixm } @{$selected_hst_columns});
