...
# Excel Export
    ...
    '/thruk/cgi-bin/status.cgi?style=hostdetail&view_mode=xls', # No selection
    '/thruk/cgi-bin/status.cgi?style=hostdetail&view_mode=xls&columns=host_name,contacts,comments',
    '/thruk/cgi-bin/status.cgi?style=hostdetail&view_mode=xls&status_hostdetail_excel_columns=Hostname&status_hostdetail_excel_columns=IP&status_hostdetail_excel_columns=Status&status_hostdetail_excel_columns=Acknowledged&status_hostdetail_excel_columns=Downtime&status_hostdetail_excel_columns=Notifications&status_hostdetail_excel_columns=Active%20Checks&status_hostdetail_excel_columns=Flapping&status_hostdetail_excel_columns=Last%20Check&status_hostdetail_excel_columns=Contacts&status_hostdetail_excel_columns=Duration&status_hostdetail_excel_columns=Status%20Information', # Default selection, Excel selection fields have prefixes to differentiate between CSV selection fields
    '/thruk/cgi-bin/status.cgi?style=hostdetail&view_mode=xls&status_hostdetail_excel_columns=Site&status_hostdetail_excel_columns=Hostname&status_hostdetail_excel_columns=Displayname&status_hostdetail_excel_columns=IP&status_hostdetail_excel_columns=Alias&status_hostdetail_excel_columns=Parents&status_hostdetail_excel_columns=Groups&status_hostdetail_excel_columns=Status&status_hostdetail_excel_columns=Acknowledged&status_hostdetail_excel_columns=Downtime&status_hostdetail_excel_columns=Notifications&status_hostdetail_excel_columns=Active%20Checks&status_hostdetail_excel_columns=Flapping&status_hostdetail_excel_columns=Last%20Check&status_hostdetail_excel_columns=Contacts&status_hostdetail_excel_columns=Duration&status_hostdetail_excel_columns=Status%20Information&status_hostdetail_excel_columns=Extra%20Status%20Information&status_hostdetail_excel_columns=Comments', # All selection, Excel selection fields have prefixes to differentiate between CSV selection fields prefixes
    '/thruk/cgi-bin/status.cgi?style=combined&view_mode=xls', # No selection
    '/thruk/cgi-bin/status.cgi?style=combined&hst_s0_hoststatustypes=4&hst_s0_servicestatustypes=31&hst_s0_hostprops=10&hst_s0_serviceprops=0&svc_s0_hoststatustypes=3&svc_s0_servicestatustypes=28&svc_s0_hostprops=10&svc_s0_serviceprops=10&svc_s0_hostprop=2&svc_s0_hostprop=8&title=All+Unhandled+Problems&view_mode=xls',
    '/thruk/cgi-bin/status.cgi?style=combined&view_mode=xls&style=combined&nav=1&hidetop=1&title=&CSRFtoken=43e7da2254061f9802e4daa891dd395a0abf519b3e09b8324381ba2290ada103_1&newname=&host_columns=Hostname&host_columns=IP&host_columns=Status&host_columns=Acknowledged&host_columns=Downtime&host_columns=Notifications&host_columns=Active%20Checks&host_columns=Flapping&host_columns=Last%20Check&host_columns=Contacts&host_columns=Duration&host_columns=Status%20Information&host_columns=Extra%20Status%20Information&service_columns=Hostname&service_columns=IP&service_columns=Host%20Acknowledged&service_columns=Host%20Downtime&service_columns=Host%20Notifications&service_columns=Host%20Active%20Checks&service_columns=Host%20Flapping&service_columns=Service&service_columns=Status&service_columns=Last%20Check&service_columns=Contacts&service_columns=Duration&service_columns=Attempt&service_columns=Acknowledged&service_columns=Downtime&service_columns=Notifications&service_columns=Active%20Checks&service_columns=Flapping&service_columns=Status%20Information&service_columns=Extra%20Status%20Information&hst__columns_select=name&hst__columns_select=state&hst__columns_select=last_check&hst__columns_select=duration&hst__columns_select=current_attempt&hst__columns_select=plugin_output&hst_s0_hoststatustypes=15&hst_s0_servicestatustypes=31&hst_s0_hostprops=0&hst_s0_serviceprops=0&hst_s0_val_pre=&hst_s0_value=&svc__columns_select=host_name&svc__columns_select=description&svc__columns_select=state&svc__columns_select=last_check&svc__columns_select=duration&svc__columns_select=current_attempt&svc__columns_select=plugin_output&svc_s0_hoststatustypes=15&svc_s0_servicestatustypes=31&svc_s0_hostprops=0&svc_s0_serviceprops=0&svc_s0_val_pre=&svc_s0_value=', # Default selection, Excel selection fields have prefixes to differentiate between CSV selection fields
    'https://localhost:19443/dev/thruk/cgi-bin/status.cgi?style=combined&view_mode=xls&style=combined&nav=1&hidetop=1&title=&CSRFtoken=43e7da2254061f9802e4daa891dd395a0abf519b3e09b8324381ba2290ada103_1&newname=&host_columns=Hostname&host_columns=Displayname&host_columns=IP&host_columns=Status&host_columns=Alias&host_columns=Parents&host_columns=Groups&host_columns=Acknowledged&host_columns=Downtime&host_columns=Notifications&host_columns=Active%20Checks&host_columns=Flapping&host_columns=Last%20Check&host_columns=Contacts&host_columns=Duration&host_columns=Status%20Information&host_columns=Extra%20Status%20Information&service_columns=Hostname&service_columns=Hostdisplayname&service_columns=IP&service_columns=Host%20Alias&service_columns=Host%20Parents&service_columns=Host%20Groups&service_columns=Host%20Acknowledged&service_columns=Host%20Downtime&service_columns=Host%20Notifications&service_columns=Host%20Active%20Checks&service_columns=Host%20Flapping&service_columns=Service&service_columns=Displayname&service_columns=Status&service_columns=Last%20Check&service_columns=Contacts&service_columns=Duration&service_columns=Attempt&service_columns=Acknowledged&service_columns=Downtime&service_columns=Notifications&service_columns=Active%20Checks&service_columns=Flapping&service_columns=Status%20Information&service_columns=Extra%20Status%20Information&hst__columns_select=name&hst__columns_select=state&hst__columns_select=last_check&hst__columns_select=duration&hst__columns_select=current_attempt&hst__columns_select=plugin_output&hst_s0_hoststatustypes=15&hst_s0_servicestatustypes=31&hst_s0_hostprops=0&hst_s0_serviceprops=0&hst_s0_val_pre=&hst_s0_value=&svc__columns_select=host_name&svc__columns_select=description&svc__columns_select=state&svc__columns_select=last_check&svc__columns_select=duration&svc__columns_select=current_attempt&svc__columns_select=plugin_output&svc_s0_hoststatustypes=15&svc_s0_servicestatustypes=31&svc_s0_hostprops=0&svc_s0_serviceprops=0&svc_s0_val_pre=&svc_s0_value=', # All selection, Excel selection fields have prefixes to differentiate between CSV selection fields
    '/thruk/cgi-bin/status.cgi?style=perfmap', # No selection
    '/thruk/cgi-bin/status.cgi?style=perfmap&dfl_s0_type=service&dfl_s0_op=%3D&dfl_s0_value='.$service.'&view_mode=xls', # No selection
