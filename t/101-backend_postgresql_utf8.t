...
plan skip_all => 'Set $ENV{TEST_POSTGRESQL} to a test database connection.' unless $ENV{TEST_POSTGRESQL};
plan tests => 14;
...
#####################################################################
# create connection
my $m = Thruk::Backend::Provider::Postgresql->new({options => {peer => $ENV{'TEST_POSTGRESQL'}, peer_key => 'abcd'}});
